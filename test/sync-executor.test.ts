...
async function testFrontmatterUpdate(): Promise<void> {
  await ensureTestDir();
...
async function testSyncExecutionResultType(): Promise<void> {
...
async function testHacknPlanClient(): Promise<void> {
