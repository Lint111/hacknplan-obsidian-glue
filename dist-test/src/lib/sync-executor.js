 ...
 */
export async function updateVaultFileFrontmatter(filePath, updates) {
 ...
 */
export async function revertVaultFile(filePath, originalContent) {
    const tempPath = `${filePath}.tmp`;
 ...
 */
export async function executeCreateOperation(op, projectId, client, syncState, rollbackStack) {
    let hacknplanElement = null;
 ...
 */
export async function executeUpdateOperation(op, projectId, client, syncState, rollbackStack) {
    try {
 ...
 * @param syncState - Sync state manager
 */
export async function rollbackOperations(rollbackStack, client, syncState) {
 ...
 */
export async function checkOperationConflict(sourceFile, syncState, hacknplanUpdatedAt) {
    ...
    try {
        ...
        const conflictResult = conflictResolver.detectConflict(fileStat.mtimeMs, hacknplanUpdatedAt, existingState);
        return {
 ...
 */
export async function executeSyncBatch(creates, updates, projectId, client, syncState, options = {}) {
